...
class CustomerServiceProviderImpl(ICustomerServiceProvider):
    ...
    def list_accounts(self):
        sorted_accounts = sorted(self.accounts, key=lambda x: (x.customer.first_name, x.customer.last_name))
        for account in sorted_accounts:
            print("Account Number:", account.account_number)
            print("Customer Name:", account.customer.first_name, account.customer.last_name)
            print("Account Balance:", account.account_balance)
            print()